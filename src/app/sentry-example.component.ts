...
@Component({
    ...
    template: `
        ...
        <p class="description">
            ...
            <a target="_blank" href="https://1maiprogram.sentry.io/issues/?project=4510201399148624"
                >Issues Page</a
            >. For more details about setting up Sentry,
            <a target="_blank" href="https://docs.sentry.io/platforms/javascript/guides/angular/"
                >read our docs</a
            >.
        </p>
        ...
        <div *ngIf="isConnected && sentError" class="success">Sample error was sent to Sentry.</div>
